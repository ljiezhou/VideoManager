...
import com.ds.common.ext.util.loge
...
import com.ds.common.net.state.ResultState
import com.ds.common.net.state.paresException
import com.ds.common.net.state.paresResult
    ...
    return viewModelScope.launch {
        runCatching {
            ...
            runCatching {
                ...
                com.ds.common.net.executeResponse(it) { t ->
                    success(t)
                }
            }.onFailure { e ->
                //打印错误消息
